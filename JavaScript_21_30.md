...
* **CDTASection** 
```html
Entity를 쓰다보면 그 기호를 쓰는 것에 대한 불편함도 있음. <![CDATA[<,>,]]> 특수기호 마음껏 써도 됨
```  
* **Notation** 
```html
<font color = <b>"#ffff00"</b> size = **"10px"**> 속성의 값으로 설정하는 것 중에서 어떤 표현형식을 사용할수 있게 해주는 표기법에 대한 내용을 담고 있음
```  
